                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-2xl p-6 relative max-h-[90vh] overflow-y-auto border border-gray-100 dark:border-slate-700" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSaveOtherUser} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-4 border-t dark:border-slate-700">
                                <button type="button" onClick={() => setShowEditModal(false)} className="px-4 py-2 bg-gray-200 dark:bg-slate-700 dark:text-white rounded-xl hover:bg-gray-300 dark:hover:bg-slate-600 transition">Hủy</button>
                                <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">Lưu</button>
                            </div>
                        </form>
                    </div>
                </div>
