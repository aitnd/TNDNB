  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4 animate-slide-in-right pb-24">
      <div className="relative text-center mb-10 pt-4">
        ...
        <h1 className="text-3xl font-black text-foreground  uppercase tracking-tight">Chọn Môn học</h1>
        <p className="text-base text-muted-foreground mt-2">Chọn một môn để bắt đầu ôn tập.</p>
      </div>
      ...
      <div className="mb-4">
        <input 
          ...
          className="w-full p-4 rounded-2xl bg-card border border-border text-foreground placeholder:text-muted-foreground shadow-sm focus:outline-none focus:border-blue-500"
        />
        {searchTerm && (
          <button 
      ...
      <div className="flex justify-between items-center mb-4 gap-4">
        <button
            ...
            className="flex-1 bg-destructive/10 text-destructive font-bold p-4 rounded-2xl shadow-sm active:scale-95 transition-all text-center border border-destructive/20"
        >
          ...
          {subjects.map((subject, index) => {
            ...
            return (
              <button
                ...
                className="w-full group relative overflow-hidden flex flex-col p-5 bg-card  rounded-3xl text-left border border-border  shadow-md active:scale-[0.97] transition-all hover:border-blue-300"
              >
                {hasProgress && (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex-none w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center font-black text-foreground  group-hover:bg-blue-600 group-hover:text-white transition-colors">
                      {index + 1}
                    </div>
                    <div>
                      <h3 className="text-lg font-black text-foreground  leading-tight mb-1">{subject.name}</h3>
