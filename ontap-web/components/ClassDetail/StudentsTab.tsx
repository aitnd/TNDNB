          ...
          <AnimatePresence>
            {paginatedStudents.map((st) => (
              <motion.div
                ...
                className={`group relative bg-card dark:bg-slate-900 rounded-3xl p-6 border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300 ${st.status === 'disabled' ? 'opacity-60 bg-gray-50/50 dark:bg-slate-950/20' : ''}`}
              >
