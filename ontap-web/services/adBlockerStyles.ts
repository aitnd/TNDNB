/**
 * 🛡️ AdSense Selective Block CSS — Shared Styles
 * 
 * Chiến lược 2 tầng:
 ...
 * 
 * Quảng cáo In-page (banner trong bài viết) → bị khóa click, vẫn hiển thị → giữ Impression
 * Quảng cáo Overlay (Anchor, Vignette) → hoạt động bình thường → user không bị kẹt
 */
