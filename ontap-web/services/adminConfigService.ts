...
export interface RoleConfig {
    ...
    showMonetag?: boolean;
    showDirectLink?: boolean;       // 🔗 Bật/Tắt Monetag Direct Link trên nút hành động
    showAutoPopunder?: boolean;     // 🖱️ Bật/Tắt auto-click popunder (mở Direct Link khi click lần đầu)
    showCountdownAd?: boolean;      // ⏱️ Bật/Tắt trang đếm ngược QC trước khi xem kết quả
    message: string;
