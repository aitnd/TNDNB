...
**1. Verify:** Chạy
`npx tsc --noEmit` trên cả ontap-web và ontap-win.
...
**1. Verify:** Chạy
`npm run preview`. Mở trình duyệt ẩn danh.
**2. Implement:**
...
**1. Implement:**
- Lưu lại log build và test vào `build_report.md`.
- Đánh dấu hoàn thành toàn bộ `task.md`.
