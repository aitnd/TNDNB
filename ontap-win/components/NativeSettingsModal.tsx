        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-[32px] overflow-hidden shadow-2xl border border-white/10 animate-scale-up">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex flex-col p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                        ...
                        {notificationsEnabled && (
                            <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700 flex justify-between items-center">
                                <label className="text-sm font-bold text-slate-700 dark:text-slate-300">Giờ nhắc học</label>
                                <input
                                    type="time"
                                    value={localStorage.getItem('reminderTime') || '19:00'}
                                    onChange={(e) => {
                                        import('../utils/reminder').then(r => r.scheduleLocalReminder(e.target.value, () => {
