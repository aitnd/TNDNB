                    ...
                    <div className="relative">
                        ...
                        {showLinksDropdown && (
                            <div className="fixed mt-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl py-2 min-w-[200px] z-[100]" style={{ top: '56px' }}>
                                ...
                                {/* Ẩm thực */}
                                <a href="https://daotaothuyenvien.com/amthuc" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-2.5 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
