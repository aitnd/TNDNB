...
## [3.18.0] - 2026-09-16
### PhÃ³ng to toÃ n mÃ n hÃ¬nh báº±ng phÃ­m táº¯t (App Win)
- **Zoom cáº£ giao diá»‡n:** Giá»¯ phÃ­m `Ctrl` rá»“i lÄƒn chuá»™t (hoáº·c `Ctrl + dáº¥u cá»™ng/trá»«`, `Ctrl + sá»‘ 0` Ä‘á»ƒ vá» cá»¡ chuáº©n) Ä‘á»ƒ phÃ³ng to hoáº·c thu nhá» toÃ n bá»™ mÃ n hÃ¬nh. Má»©c zoom Ä‘Æ°á»£c nhá»› cho láº§n má»Ÿ sau.

## [3.17.0] - 2026-09-16
### Sá»­a lá»—i Ä‘Äƒng nháº­p, thÃªm thanh zoom Ä‘á» thi, tÃ¡ch báº£n cÃ i x64/x32 (App Win)
...
- **Báº£o máº­t:** VÃ¡ cÃ¡c lá»— há»•ng thÆ° viá»‡n cá»§a báº£n Windows.
...
- **á»”n Ä‘á»‹nh hÃ³a há»‡ thá»‘ng**: ÄÃ£ thá»±c hiá»‡n build vÃ  kiá»ƒm thá»­ (`npm run build`) trong thÆ° má»¥c `ontap-win` Ä‘áº£m á»©ng dá»¥ng khÃ´ng cÃ²n bá»‹ crash khi render.
