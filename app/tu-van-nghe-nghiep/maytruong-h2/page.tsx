...
export default function TuVanM2Page() {
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>
        Tư vấn: Máy trưởng hạng nhì (M2)
      </h1>
      
      <div className={styles.content}>
        
        <h3>I. Điều kiện dự học và thi cấp GCNKNCM Máy trưởng hạng nhì (M2)</h3>
        ...
        <p>Ngoài các điều kiện chung trên, người dự thi, kiểm tra để được cấp GCNKNCM Máy trưởng hạng nhì phải bảo đảm điều kiện cụ thể sau:</p>
        <ul>
          <li>a) Có GCNKNCM máy trưởng hạng ba, có thời gian đảm nhiệm chức danh máy trưởng hạng ba đủ 12 tháng trở lên hoặc có chứng chỉ sơ cấp nghề máy trưởng hạng ba, có thời gian tập sự đủ 06 tháng trở lên;</li>
          <li>b) Đối với người đã có bằng tốt nghiệp trung cấp được đào tạo nghề máy tàu thủy hoặc máy tàu biển, hoàn thành thời gian tập sự theo chức danh máy trưởng hạng ba đủ 06 tháng trở lên được dự thi để cấp GCNKNCM máy trưởng hạng nhì, không phải dự học chương trình tương ứng.</li>
        </ul>
