...
export default function ThuyenTruongH1Page() {
  // 💖 (DỮ LIỆU T1 - ĐÃ "SỬA" THEO ẢNH MỚI) 💖
  const data = {
    title: '3- GCNKNCM THUYỀN TRƯỞNG HẠNG NHẤT',
    ...
    modules: [
      ...
      { ma: "MĐ 02", ten: "Tự động hóa trong điều khiển", thoi_gian: "13" },
      { ma: "MĐ 03", ten: "Hàng hải và thiết bị hàng hải", thoi_gian: "35" },
      { ma: "MĐ 04", ten: "Điều động phương tiện", thoi_gian: "45" },
      { ma: "MH 05", ten: "Kinh tế vận tải", thoi_gian: "30" },
      { ma: "MH 06", ten: "Luồng đường thủy nội địa", thoi_gian: "10" },
      { ma: "MĐ 07", ten: "Khí tượng thủy văn", thoi_gian: "10" },
      { ma: "MH 08", ten: "Nghiệp vụ thuyền trưởng", thoi_gian: "10" },
    ],
    module_total: "168",
    final_tests: [
      // (Em "phỏng đoán" Bảng 2 từ các hạng Thuyền trưởng khác)
