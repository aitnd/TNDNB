...
export default function AnToanHoaChatPage() {
  // 💖 (DỮ LIỆU MỚI CHO "AN TOÀN HÓA CHẤT" - TỪ ẢNH) 💖
  const data = {
    title: '6- CHỨNG CHỈ AN TOÀN LÀM VIỆC TRÊN PHƯƠNG TIỆN CHỞ HÓA CHẤT',
    subtitle: 'DANH MỤC MÔN HỌC, MÔ ĐUN VÀ THỜI GIAN ĐÀO TẠO',
    modules: [
      { ma: "MH 01", ten: "Giới thiệu về hoá chất", thoi_gian: "10" },
      { ma: "MĐ 02", ten: "An toàn làm việc trên phương tiện chở hoá chất", thoi_gian: "15" },
      { ma: "MH 03", ten: "Vận hành hệ thống làm hàng trên phương tiện chở hoá chất", thoi_gian: "15" },
    ],
    module_total: "40",
    final_tests: [
