## [3.18.1] - 2026-09-18
### Nâng cấp trải nghiệm tải dữ liệu & Sửa lỗi giao diện (Web & App Win)
- **Tải dữ liệu ngầm (Windows):** Cửa sổ tải dữ liệu nay không còn chặn toàn bộ màn hình. Quá trình kiểm tra và cập nhật sẽ chạy ngầm với thông báo nhỏ, giúp bạn ôn tập không gián đoạn.
- **Sửa lỗi giao diện:** Khắc phục lỗi thanh thống kê trạng thái bị che khuất bởi thanh menu ở phía trên cùng màn hình.

## [3.18.0] - 2026-09-16
### PhÃ³ng to toÃ n mÃ n hÃ¬nh báº±ng phÃ­m táº¯t (Web & App Win)
- **Zoom cáº£ giao diá»‡n:** Giá»¯ phÃ­m `Ctrl` rá»“i lÄƒn chuá»™t (hoáº·c `Ctrl + dáº¥u cá»™ng/trá»«`, `Ctrl + sá»‘ 0` Ä‘á»ƒ vá» cá»¡ chuáº©n) Ä‘á»ƒ phÃ³ng to hoáº·c thu nhá» toÃ n bá»™ mÃ n hÃ¬nh, giá»‘ng nhÆ° trÃªn trÃ¬nh duyá»‡t. Má»©c zoom Ä‘Æ°á»£c nhá»› cho láº§n má»Ÿ sau.

## [3.17.0] - 2026-09-16
### Sá»­a lá»—i Ä‘Äƒng nháº­p, thÃªm thanh zoom Ä‘á» thi, tÃ¡ch báº£n cÃ i x64/x32 (Web & App Win)
- **Háº¿t káº¹t mÃ n hÃ¬nh Ä‘Äƒng nháº­p:** TrÆ°á»›c Ä‘Ã¢y Ä‘Äƒng nháº­p sai hoáº·c máº¥t máº¡ng thÃ¬ nÃºt quay mÃ£i, pháº£i táº¯t app má»Ÿ láº¡i. Nay sau tá»‘i Ä‘a 15 giÃ¢y sáº½ bÃ¡o lá»—i rÃµ rÃ ng vÃ  cho Ä‘Äƒng nháº­p láº¡i ngay.
- **Thanh zoom kiá»ƒu Word:** ThÃªm thanh thu/phÃ³ng cá»¡ chá»¯ (50%â€“200%) dÆ°á»›i má»—i mÃ n hÃ¬nh lÃ m bÃ i vÃ  thi, chá»‰ phÃ³ng to ná»™i dung cÃ¢u há»i vÃ  Ä‘Ã¡p Ã¡n, khÃ´ng lÃ m vá»¡ giao diá»‡n.
- **Báº£n cÃ i riÃªng x64/x32:** MÃ¡y Windows 32-bit nay cÃ³ file cÃ i Ä‘áº·t riÃªng, khÃ´ng cÃ²n bá»‹ ghi Ä‘Ã¨; cáº­p nháº­t tá»± Ä‘á»™ng váº«n hoáº¡t Ä‘á»™ng bÃ¬nh thÆ°á»ng.
- **Báº£o máº­t:** VÃ¡ cÃ¡c lá»— há»•ng thÆ° viá»‡n á»Ÿ cáº£ báº£n Web vÃ  báº£n Windows.

## [3.16.0] - 2026-07-09
### TÃ¡ch phÃ¢n há»‡ áº¨m thá»±c & Tá»‘i Æ°u hÃ³a Ä‘iá»u hÆ°á»›ng (Web & App Win)
- **Cáº­p nháº­t há»‡ thá»‘ng:** HoÃ n thÃ nh viá»‡c tÃ¡ch phÃ¢n há»‡ áº¨m thá»±c (Food & Attraction) sang á»©ng dá»¥ng riÃªng biá»‡t `thodia.hlstudio.top` Ä‘á»ƒ tá»‘i Æ°u tÃ i nguyÃªn vÃ  tá»‘c Ä‘á»™ cá»§a há»‡ thá»‘ng Ã´n táº­p.
- **Tá»‘i Æ°u Ä‘iá»u hÆ°á»›ng:** Cáº­p nháº­t láº¡i cÃ¡c liÃªn káº¿t trÃªn thanh Ä‘iá»u hÆ°á»›ng, chuyá»ƒn hÆ°á»›ng chÃ­nh xÃ¡c ngÆ°á»i dÃ¹ng sang trang web áº¨m thá»±c má»›i.
- **Dá»n dáº¹p mÃ£ nguá»“n:** XÃ³a bá» sitemap vÃ  cÃ¡c thÃ nh pháº§n build cÅ© khÃ´ng cÃ²n sá»­ dá»¥ng cá»§a phÃ¢n há»‡ áº¨m thá»±c, giÃºp há»‡ thá»‘ng nháº¹ vÃ  á»•n Ä‘á»‹nh hÆ¡n.

## [3.15.10] - 2026-07-06
### HoÃ n thiá»‡n báº£o vá»‡ quáº£ng cÃ¡o & Tá»‘i Æ°u giao diá»‡n thi thá»­ (Web & App Win)
- **Tá»‘i Æ°u hiá»ƒn thá»‹ thi thá»­:** NÃ¢ng cáº¥p tÃ­nh nÄƒng tá»± Ä‘á»™ng co giÃ£n giao diá»‡n (Responsive) trÃªn mÃ n hÃ¬nh thi thá»­. CÃ¡c nÃºt Ä‘Ã¡p Ã¡n vÃ  thiáº¿t káº¿ báº£ng Ä‘iá»n sáº½ tá»± Ä‘á»™ng chuyá»ƒn Ä‘á»•i thÃ´ng minh, hiá»ƒn thá»‹ Ä‘áº¹p máº¯t vÃ  Ä‘áº§y Ä‘á»§ tÃ­nh nÄƒng dÃ¹ há»c viÃªn Ä‘ang má»Ÿ trÃªn mÃ¡y tÃ­nh (PC) hay Ä‘iá»‡n thoáº¡i.
- **Báº£o vá»‡ há»‡ thá»‘ng & Báº­t táº¯t tÃ­nh nÄƒng:** NÃ¢ng cáº¥p cÆ¡ cháº¿ cháº·n spam vÃ  báº£o vá»‡ ngÆ°á»i dÃ¹ng, Ä‘á»“ng thá»i tá»‘i Æ°u há»‡ thá»‘ng báº­t táº¯t cÃ¡c thÃ´ng bÃ¡o/quáº£ng cÃ¡o Ä‘á»ƒ khÃ´ng áº£nh hÆ°á»Ÿng Ä‘áº¿n tráº£i nghiá»‡m thao tÃ¡c trÃªn mÃ n hÃ¬nh.

## [3.15.9] - 2026-07-02
### Tá»‘i Æ°u hÃ³a Ä‘iá»u hÆ°á»›ng vÃ  hiá»ƒn thá»‹ trÃªn thiáº¿t bá»‹ di Ä‘á»™ng (Web & App Win)
- **Tá»‘i Æ°u hÃ³a tÆ°Æ¡ng tÃ¡c:** Cáº£i thiá»‡n kháº£ nÄƒng pháº£n há»“i cá»§a cÃ¡c nÃºt Ä‘Ã³ng, áº©n báº£ng tin, vÃ  cÃ¡c thanh neo Ä‘iá»u hÆ°á»›ng cá»‘ Ä‘á»‹nh trÃªn mÃ n hÃ¬nh thiáº¿t bá»‹ di Ä‘á»™ng, Ä‘áº£m báº£o ngÆ°á»i dÃ¹ng luÃ´n tÆ°Æ¡ng tÃ¡c mÆ°á»£t mÃ  trong má»i tÃ¬nh huá»‘ng.

## [3.15.8] - 2026-07-02
### Sá»­a lá»—i Import Há»c viÃªn tá»« Excel (Web)
- **Sá»­a lá»—i Excel Import:** Kháº¯c phá»¥c lá»—i crash á»©ng dá»¥ng khi táº£i lÃªn file Excel Ä‘á»ƒ táº¡o hÃ ng loáº¡t tÃ i khoáº£n há»c viÃªn trÃªn trÃ¬nh duyá»‡t Web (do lá»—i báº¥t Ä‘á»“ng bá»™ khi Ä‘á»c file). Báº£n á»©ng dá»¥ng Windows vÃ  cÃ¡c tÃ­nh nÄƒng khÃ¡c hoáº¡t Ä‘á»™ng bÃ¬nh thÆ°á»ng.

## [3.15.7] - 2026-06-30
### NÃ¢ng cáº¥p giao diá»‡n Mobile & Thiáº¿t káº¿ Ä‘iá»u hÆ°á»›ng má»›i (Web & App Win)
- **Mobile Header:** ThÃªm má»›i thanh tiÃªu Ä‘á» `MobileHeader` hiá»ƒn thá»‹ logo TND vÃ  thÃ´ng tin cÃ¡ nhÃ¢n/avatar cá»§a há»c viÃªn khi cháº¡y trÃªn cÃ¡c thiáº¿t bá»‹ di Ä‘á»™ng.
- **Äiá»u hÆ°á»›ng thÃ´ng minh:** TÃ¡i thiáº¿t káº¿ thanh Ä‘iá»u hÆ°á»›ng dÆ°á»›i cÃ¹ng `MobileBottomNav` vá»›i 3 nÃºt chÃ­nh trá»±c quan hÆ¡n gá»“m **Trang chá»§**, **Lá»‹ch sá»­**, **Lá»›p há»c** (tá»± Ä‘á»™ng thay Ä‘á»•i biá»ƒu tÆ°á»£ng theo vai trÃ² GiÃ¡o viÃªn/Há»c sinh).
- **Má»Ÿ rá»™ng Menu phá»¥:** TÃ­ch há»£p cÃ¡c nÃºt chá»©c nÄƒng nÃ¢ng cao vÃ o menu phá»¥ gá»“m Há»™p thÆ°, Cáº¥u hÃ¬nh (cho quáº£n trá»‹ viÃªn) vÃ  liÃªn káº¿t Táº£i App.
- **Tá»‘i Æ°u hiá»ƒn thá»‹:** NhÃºng trá»±c tiáº¿p Header/Bottom Nav vÃ o luá»“ng á»©ng dá»¥ng chÃ­nh, Ä‘áº£m báº£o cÄƒn lá» an toÃ n (safe-area) trÃªn cÃ¡c thiáº¿t bá»‹ di Ä‘á»™ng tai thá»/trÃ n viá»n.

## [3.15.6] - 2026-06-30
### Tá»‘i Æ°u hÃ³a á»©ng dá»¥ng
- **Cáº£i thiá»‡n Ä‘á»™ á»•n Ä‘á»‹nh:** Tá»‘i Æ°u hÃ³a cáº¥u trÃºc há»‡ thá»‘ng giÃºp á»©ng dá»¥ng cháº¡y nháº¹ nhÃ ng vÃ  á»•n Ä‘á»‹nh hÆ¡n.

## [3.15.5] - 2026-06-30
### Kháº¯c phá»¥c lá»—i hiá»ƒn thá»‹ thá»i tiáº¿t & Tá»‘i Æ°u hÃ³a há»‡ thá»‘ng (Web & App Win)
- **Thá»i tiáº¿t local**: Äá»“ng bá»™ hÃ³a mÃºi giá» thá»±c táº¿ cá»§a há»c viÃªn (+7) thay vÃ¬ sá»­ dá»¥ng mÃºi giá» UTC cá»§a mÃ¡y chá»§, Ä‘áº£m báº£o hiá»ƒn thá»‹ Ä‘Ãºng giá» Viá»‡t Nam táº¡i má»i thá»i Ä‘iá»ƒm trong ngÃ y.
- **Giao diá»‡n thá»i tiáº¿t**: Kháº¯c phá»¥c lá»—i áº©n tooltip tráº¡ng thÃ¡i káº¿t ná»‘i báº±ng cÃ¡ch loáº¡i bá» giá»›i háº¡n trÃ n (overflow) trÃªn pháº§n tá»­ bao ngoÃ i, Ä‘á»“ng thá»i tÄƒng kÃ­ch thÆ°á»›c biá»ƒu tÆ°á»£ng tráº¡ng thÃ¡i Ä‘á»ƒ tÄƒng tÃ­nh trá»±c quan.
- **Tá»‘i Æ°u hiá»‡u nÄƒng**: TÃ¡i cáº¥u trÃºc luá»“ng táº£i vÃ  Ä‘iá»u hÆ°á»›ng á»©ng dá»¥ng giÃºp khá»Ÿi Ä‘á»™ng nhanh hÆ¡n, tiáº¿t kiá»‡m bá»™ nhá»› vÃ  hoáº¡t Ä‘á»™ng á»•n Ä‘á»‹nh trÃªn má»i thiáº¿t bá»‹.
- **Äá»™ á»•n Ä‘á»‹nh há»‡ thá»‘ng**: Kháº¯c phá»¥c triá»‡t Ä‘á»ƒ cÃ¡c xung Ä‘á»™t ngáº§m vÃ  dá»n dáº¹p mÃ£ nguá»“n dÆ° thá»«a.

## [3.15.4] - 2026-06-30
### Cáº­p nháº­t há»‡ thá»‘ng Quáº£n trá»‹ & Kháº¯c phá»¥c lá»—i PhÃ¡t hÃ nh (Web & App Win)
- **Tá»± Ä‘á»™ng hÃ³a phÃ¡t hÃ nh**: Sá»­a lá»—i giÃ¡n Ä‘oáº¡n khi phÃ¡t hÃ nh á»©ng dá»¥ng trÃ¹ng tÃªn hoáº·c trÃ¹ng tháº» phiÃªn báº£n (há»‡ thá»‘ng tá»± Ä‘á»™ng Ä‘á»“ng bá»™ hÃ³a vÃ  dá»n dáº¹p cÃ¡c tháº» Git Tag cÅ© trÃªn GitHub).
- **Trá»±c quan hÃ³a cÃ i Ä‘áº·t**: NÃ¢ng cáº¥p Giao diá»‡n Quáº£n lÃ½ Há»‡ thá»‘ng dÃ nh cho Admin, tÃ­ch há»£p chá»‰ bÃ¡o mÃ u sáº¯c ná»•i báº­t vÃ  tháº» cáº£nh bÃ¡o khi táº¯t cÃ¡c dá»‹ch vá»¥ phá»¥ trá»£ nháº±m nÃ¢ng cao tráº£i nghiá»‡m váº­n hÃ nh.

## [3.15.3] - 2026-06-30
### Sá»­a lá»—i hiá»ƒn thá»‹ Huy hiá»‡u Admin & Tá»‘i Æ°u hÃ³a xÃ¡c thá»±c Quáº£ng cÃ¡o (Web & App Win)
- **Huy hiá»‡u Admin:** Kháº¯c phá»¥c lá»—i áº©n Huy hiá»‡u Ä‘áº·c quyá»n (vÆ°Æ¡ng miá»‡n láº¥p lÃ¡nh ðŸ‘‘) cá»§a Admin/LÃ£nh Ä‘áº¡o trÃªn Tháº» giÃ¡o viÃªn, thanh TopNavbar gÃ³c pháº£i vÃ  trang Há»“ sÆ¡ cÃ¡ nhÃ¢n.
- **XÃ¡c thá»±c há»‡ thá»‘ng:** Cáº£i tiáº¿n ká»¹ thuáº­t nhÃºng liÃªn káº¿t Ä‘á»‘i tÃ¡c trÃªn Portal Next.js dÆ°á»›i dáº¡ng tháº» script HTML tÄ©nh thÃ´ trá»±c tiáº¿p trong head, giÃºp há»‡ thá»‘ng bÃªn ngoÃ i dá»… dÃ ng quÃ©t vÃ  xÃ¡c minh.

## [3.15.2] - 2026-06-30
### Cáº­p nháº­t há»‡ thá»‘ng chá»‰ bÃ¡o thá»i tiáº¿t & Tá»‘i Æ°u hÃ³a háº¡ táº§ng (Web & App Win)
- **Chá»‰ bÃ¡o thá»i tiáº¿t:** ThÃªm icon chá»‰ bÃ¡o Ä‘á»™ng (TÃ­n hiá»‡u káº¿t ná»‘i) vÃ  Tooltip chi tiáº¿t táº¡i gÃ³c giao diá»‡n thá»i tiáº¿t Ä‘á»ƒ hiá»ƒn thá»‹ rÃµ nguá»“n dá»¯ liá»‡u (Äang táº£i trá»±c tiáº¿p, Æ¯á»›c tÃ­nh tá»« há»‡ thá»‘ng, hoáº·c Máº¥t káº¿t ná»‘i táº¡m thá»i).
- **Háº¡ táº§ng:** Tá»‘i Æ°u hÃ³a luá»“ng táº£i mÃ£ nguá»“n vÃ  cáº£i thiá»‡n tá»‘c Ä‘á»™ káº¿t ná»‘i há»‡ thá»‘ng.

## [3.15.1] - 2026-06-30
### Cáº­p nháº­t há»‡ thá»‘ng (Web & App Win)
- **Thá»i tiáº¿t má»Ÿ rá»™ng:** NÃ¢ng cáº¥p widget thá»i tiáº¿t hiá»ƒn thá»‹ chi tiáº¿t 8 má»‘c thá»i gian (thay vÃ¬ 5) dá»±a trÃªn API thá»±c táº¿ hoáº·c giá» Ä‘á»™ng cá»§a mÃ¡y há»c viÃªn.
- **Giao diá»‡n thá»i tiáº¿t:** Tinh chá»‰nh báº£ng mÃ u Zinc/Slate trung tÃ­nh theo thiáº¿t káº¿ má»›i, thay Ä‘á»•i thiáº¿t káº¿ pháº§n Lá»i khuyÃªn (Advice) loáº¡i bá» biá»ƒu tÆ°á»£ng emoji thÃ´ sÆ¡, thay báº±ng Banner Alert phá»‘i mÃ u tinh táº¿ tá»± Ä‘á»™ng thÃ­ch á»©ng vá»›i thá»i tiáº¿t.
- **Hiá»‡u á»©ng mÆ°á»£t mÃ :** Bá»• sung hiá»‡u á»©ng Spring Hover nháº¹ cho cÃ¡c tháº» giá» vÃ  áº©n scrollbar ngang tá»‘i giáº£n.
- **Háº¡ táº§ng:** Tá»‘i Æ°u hÃ³a vÃ  cáº­p nháº­t háº¡ táº§ng Ä‘á»ƒ tÄƒng tá»‘c Ä‘á»™ táº£i trang vÃ  Ä‘á»™ á»•n Ä‘á»‹nh cá»§a á»©ng dá»¥ng.

## [3.15.0] - 2026-06-29
### NÃ¢ng cáº¥p Giao diá»‡n Quáº£n lÃ½ Lá»›p há»c thÃ´ng minh (Web & App Win)
- **Giao diá»‡n tháº» thÃ´ng minh (Smart Cards):** Thay Ä‘á»•i giao diá»‡n danh sÃ¡ch lá»›p há»c sang dáº¡ng tháº» hiá»‡n Ä‘áº¡i, há»— trá»£ hiá»ƒn thá»‹ áº£nh Ä‘áº¡i diá»‡n (avatar) cá»§a giÃ¡o viÃªn chá»§ nhiá»‡m.
- **Thanh thá»‘ng kÃª (Insights Bar):** Bá»• sung thanh thá»‘ng kÃª trá»±c quan hiá»ƒn thá»‹ tá»•ng quan sá»‘ lÆ°á»£ng há»c viÃªn, sá»‘ lÆ°á»£t thi thá»­ vÃ  cÃ¡c chá»‰ sá»‘ quan trá»ng khÃ¡c trá»±c tiáº¿p trÃªn mÃ n hÃ¬nh quáº£n lÃ½.
- **Bá»™ lá»c nÃ¢ng cao:** ThÃªm chá»©c nÄƒng lá»c nhanh lá»›p há»c theo tráº¡ng thÃ¡i (Äang hoáº¡t Ä‘á»™ng / ÄÃ£ káº¿t thÃºc) vÃ  há»— trá»£ chuyá»ƒn Ä‘á»•i linh hoáº¡t giá»¯a cháº¿ Ä‘á»™ xem LÆ°á»›i vÃ  Danh sÃ¡ch.
- **Äá»“ng bá»™ hÃ³a 100%:** Äáº£m báº£o toÃ n bá»™ tráº£i nghiá»‡m giao diá»‡n quáº£n lÃ½ lá»›p há»c má»›i hoáº¡t Ä‘á»™ng mÆ°á»£t mÃ  trÃªn cáº£ ná»n táº£ng Web vÃ  á»©ng dá»¥ng Windows.

## [3.14.0] - 2026-06-29
### HoÃ n thiá»‡n Há»‡ thá»‘ng Huy hiá»‡u & Tá»± Ä‘á»™ng hÃ³a
- **Giao diá»‡n Quáº£n lÃ½ Huy hiá»‡u:** TÃ­ch há»£p giao diá»‡n quáº£n lÃ½ huy hiá»‡u 3D chuyÃªn nghiá»‡p vÃ o pháº§n Quáº£n lÃ½ Há»c viÃªn vÃ  Quáº£n lÃ½ Lá»›p (Web & App Win), cho phÃ©p GiÃ¡o viÃªn vÃ  LÃ£nh Ä‘áº¡o cáº¥p/thu há»“i huy hiá»‡u dá»… dÃ ng.
- **Tá»± Ä‘á»™ng nháº­n huy hiá»‡u:** Há»c viÃªn tá»± Ä‘á»™ng Ä‘Æ°á»£c theo dÃµi tiáº¿n Ä‘á»™ vÃ  nháº­n huy hiá»‡u ngay sau khi ná»™p bÃ i Ã”n táº­p vÃ  Thi thá»­ thÃ nh cÃ´ng.
- **Äá»“ng bá»™ hÃ³a 100%:** Äáº£m báº£o há»‡ thá»‘ng hoáº¡t Ä‘á»™ng thá»‘ng nháº¥t vÃ  á»•n Ä‘á»‹nh trÃªn cáº£ phiÃªn báº£n Web vÃ  á»©ng dá»¥ng Windows.

### QA Fixes
- **TypeScript Strict Compliance:** Kháº¯c phá»¥c triá»‡t Ä‘á»ƒ cÃ¡c biáº¿n rÃ¡c (unused variables) trÃªn Root Portal Ä‘á»ƒ vÆ°á»£t qua tiáº¿n trÃ¬nh `next build` kháº¯t khe.
- **Rules of Hooks:** Chuáº©n hÃ³a luá»“ng thá»±c thi React Hooks trong `AdminStatsBar` vÃ  `QuizScreen` trÃªn cáº£ báº£n Web vÃ  Windows Ä‘á»ƒ Ä‘áº£m báº£o á»•n Ä‘á»‹nh state.

## [3.13.0] - 2026-06-29
### TÃ­ch há»£p Há»‡ thá»‘ng Huy hiá»‡u & Tá»‘i Æ°u hÃ³a Táº¡o/Import Há»c viÃªn (Web & App Win)
- **Há»‡ thá»‘ng Huy hiá»‡u (Badge System):** Ra máº¯t tÃ­nh nÄƒng tÃ­ch lÅ©y huy hiá»‡u danh dá»± khi hoÃ n thÃ nh xuáº¥t sáº¯c cÃ¡c bÃ i thi vÃ  Ã´n luyá»‡n trá»±c tuyáº¿n. Bá»• sung huy hiá»‡u chá»©c danh (Admin, GiÃ¡o viÃªn, Há»c viÃªn) hiá»ƒn thá»‹ trÃªn thanh Ä‘iá»u hÆ°á»›ng vÃ  Tháº» há»c viÃªn.
- **TÃ¡i sá»­ dá»¥ng tÃ i khoáº£n an toÃ n:** Há»— trá»£ quy trÃ¬nh dá»n dáº¹p sáº¡ch sáº½ toÃ n bá»™ káº¿t quáº£ thi vÃ  huy hiá»‡u cÅ© khi tÃ¡i sá»­ dá»¥ng SBD cÅ© cho há»c viÃªn khÃ³a má»›i, giÃºp tá»‘i Æ°u cÆ¡ sá»Ÿ dá»¯ liá»‡u.
- **Import Excel thÃ´ng minh:** Bá»• sung giao diá»‡n kiá»ƒm tra trÃ¹ng láº·p trÆ°á»›c khi import. Hiá»ƒn thá»‹ báº£ng Ä‘á»‘i chiáº¿u há»c viÃªn cÅ© vs há»c viÃªn má»›i kÃ¨m cáº£nh bÃ¡o báº£o máº­t 2 lá»›p khi ghi Ä‘Ã¨ tÃ i khoáº£n Ä‘ang hoáº¡t Ä‘á»™ng.
- **Dá»n dáº¹p code:** Sá»­a lá»—i thiáº¿u tá»‡p bá» qua báº£o máº­t vÃ  xÃ³a bá» toÃ n bá»™ mÃ£ nguá»“n dÆ° thá»«a nháº±m tÄƒng tá»‘c Ä‘á»™ táº£i trang.

## [3.12.2] - 2026-06-29
### Tá»‘i Æ°u hÃ³a Giao diá»‡n Ná»­a TrÃªn Dashboard & Thanh Äiá»u HÆ°á»›ng TopNavbar (Web & App Win)
- **Tá»‘i Æ°u khÃ´ng gian hiá»ƒn thá»‹:** ÄÆ°a thanh thÃ´ng tin thá»i tiáº¿t vÃ  tráº¡ng thÃ¡i há»‡ thá»‘ng vÃ o chung má»™t hÃ ng ngang (Slim Banner Header), thu gá»n khoáº£ng tráº¯ng Ä‘á»©ng giÃºp cÃ¡c nÃºt báº¥m chá»©c nÄƒng chÃ­nh hiá»ƒn thá»‹ trá»n váº¹n ngay trong khung nhÃ¬n Ä‘áº§u tiÃªn.
- **Tinh gá»n thanh Ä‘iá»u hÆ°á»›ng:** Gom cÃ¡c nÃºt chá»©c nÄƒng quáº£n lÃ½ trÃ¹ng láº·p trÃªn TopNavbar vÃ o menu tháº£ xuá»‘ng "Há»‡ thá»‘ng" gá»n gÃ ng, mang láº¡i tráº£i nghiá»‡m lÃ m viá»‡c thÃ´ng thoÃ¡ng vÃ  chuyÃªn nghiá»‡p.

## [3.12.1] - 2026-06-29
### Tá»‘i Æ°u hÃ³a Lá»‹ch sá»­ cáº­p nháº­t (Web & App Win)
- **Táº­p trung ná»™i dung**: Cáº­p nháº­t popup thÃ´ng tin phiÃªn báº£n chá»‰ hiá»ƒn thá»‹ duy nháº¥t ná»™i dung cá»§a báº£n cáº­p nháº­t má»›i nháº¥t, giÃºp giao diá»‡n gá»n gÃ ng vÃ  dá»… theo dÃµi hÆ¡n.
- **Äá»“ng bá»™ hÃ³a cÃ¡c báº£n cÅ©**: Bá»• sung sá»‘ phiÃªn báº£n chuáº©n vÃ o táº¥t cáº£ cÃ¡c Ä‘á» má»¥c cáº­p nháº­t cÅ© trong quÃ¡ khá»©.

## [3.12.0] - 2026-06-29
### Cáº­p nháº­t há»‡ thá»‘ng báº£o trÃ¬ & NÃ¢ng cao tráº£i nghiá»‡m há»c táº­p
- **TÃ­nh nÄƒng:** NÃ¢ng cáº¥p há»‡ thá»‘ng báº£o trÃ¬ thÃ´ng minh Ä‘á»™c láº­p cho tá»«ng ná»n táº£ng (Portal, Web, Windows App) giÃºp giáº£m thiá»ƒu tá»‘i Ä‘a thá»i gian giÃ¡n Ä‘oáº¡n há»c táº­p cá»§a há»c viÃªn.
- **Tráº£i nghiá»‡m:** TÃ¡ch biá»‡t vÃ  tá»‘i Æ°u hÃ³a giao diá»‡n mÃ n hÃ¬nh thÃ´ng bÃ¡o báº£o trÃ¬, bá»• sung bá»™ Ä‘áº¿m ngÆ°á»£c thá»i gian thá»±c vÃ  tá»± Ä‘á»™ng táº£i láº¡i trang khi hoÃ n táº¥t.
- **Báº£o máº­t:** NÃ¢ng cáº¥p há»‡ thá»‘ng tÆ°á»ng lá»­a báº£o máº­t, phÃ²ng chá»‘ng cÃ¡c hÃ nh vi truy cáº­p báº¥t thÆ°á»ng lÃ m ngháº½n bÄƒng thÃ´ng há»‡ thá»‘ng.
...
- **Cáº£i tiáº¿n giao diá»‡n:** Tá»‘i Æ°u hÃ³a luá»“ng táº£i tÃ i liá»‡u vÃ  cáº£i thiá»‡n tá»‘c Ä‘á»™ chuyá»ƒn trang trÃªn trang chá»§ tin tá»©c.
- **Báº£o trÃ¬:** Bá»• sung hiá»ƒn thá»‹ thÃ´ng tin dá»± kiáº¿n báº£o trÃ¬ khi há»‡ thá»‘ng cáº­p nháº­t lá»›n.
...
- **Gá»™p cáº¥u hÃ¬nh an toÃ n:** Gá»™p cáº¥u hÃ¬nh báº£o máº­t vÃ o tab "Báº£o vá»‡ há»‡ thá»‘ng", cáº¥u hÃ¬nh táº§n suáº¥t vÃ  chu ká»³ kiá»ƒm tra thÃ´ng tin chung trÃªn toÃ n há»‡ thá»‘ng.
...
## [3.10.5] - 2026-06-25
### Tá»‘i Æ°u hÃ³a táº£i trang & Báº£o vá»‡ há»‡ thá»‘ng (Web & App Win)
- **Tá»‘i Æ°u táº£i tÃ i nguyÃªn:** Cáº£i tiáº¿n cÆ¡ cháº¿ táº£i cÃ¡c luá»“ng tÃ i nguyÃªn phá»¥ trá»£ Ä‘á»ƒ tá»‘i Æ°u hÃ³a hiá»ƒn thá»‹ dá»¯ liá»‡u vÃ  tá»‘c Ä‘á»™ pháº£n há»“i trÃªn thiáº¿t bá»‹.
- **NÃ¢ng cáº¥p báº£ng Ä‘iá»u khiá»ƒn:** Quáº£n trá»‹ viÃªn cÃ³ thá»ƒ tÃ¹y chá»‰nh giá»›i háº¡n chu ká»³ kiá»ƒm tra vÃ  thá»i gian lÃ m má»›i trá»±c tiáº¿p tá»« mÃ n hÃ¬nh "Há»‡ thá»‘ng" thay vÃ¬ cáº¥u hÃ¬nh tÄ©nh.
...
- **Quáº£n lÃ½ trang chá»§:** TÃ­ch há»£p tÃ­nh nÄƒng chuyá»ƒn Ä‘á»•i cáº¥u hÃ¬nh Ä‘á»™ng cho Next.js Portal homepage tá»« Firestore (settings/usage_config) thÃ´ng qua component client `PortalAdLoader`.
- **Äá»“ng bá»™ hÃ³a UI quáº£n trá»‹:** ThÃªm cáº¥u hÃ¬nh báº£ng Ä‘iá»u khiá»ƒn cho vai trÃ² Admin vÃ  LÃ£nh Ä‘áº¡o.
...
# #   [ 2 0 2 6 - 0 9 - 1 7 ]   -   C ­p   n h ­t   t í n h   n n g   ãt   1 + 2  
 -   F i x   b u g   t í n h   i Ãm    T / K H Ô N G    T   v à   Ón g   b Ù  t ê n   h Íc   v i ê n  
 -   C o r e :   L u y Çn   c â u   s a i ,   b i Ãu   Ó  t i ¿n   Ù,   t ì m   k i ¿m   c â u   h Ïi ,   p h í m   t ¯t ,   n h ¯c   h Íc   m ×i   n g à y  
 -   P l a t f o r m :   P W A   ( W e b ) ,   S y s t e m   T r a y   &   F u l l s c r e e n   ( W i n ) ,   C h ç  Ùn g   S y n c   d ï  l i Çu  
 
