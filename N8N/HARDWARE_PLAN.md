...
| Tiêu chí | Winner |
|----------|--------|
| **Tiết kiệm nhất** | Cấu hình A ✅ |
| **LLM local (Gemma 9B)** | Cấu hình B ✅ |
| **Future-proof** | Cấu hình B ✅ |
| **Đủ dùng cho n8n + API** | Cả 2 đều OK ✅ |

> **Đề xuất**: Nếu chênh lệch **~1.5-2 triệu** chấp nhận được → Chọn **Cấu hình B**  
> Nếu muốn tiết kiệm tối đa → **Cấu hình A** đủ dùng

---

## ⚡ Tiêu Thụ Điện (Cả 2 tương đương)

| Trạng thái | Công suất |
|------------|-----------|
| Idle | 150-200W |
| Load | 350-450W |
| Chi phí/tháng (24/7) | ~500-700k |
